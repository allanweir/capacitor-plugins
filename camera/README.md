...
| **`limit`**              | <code>number</code>                    | iOS only: Maximum number of pictures the user will be able to choose. Android: Only supports 1 or multiple    | <code>0 (unlimited)</code>        | 1.2.0 |
| **`mimeTypes`**          | <code>string[]</code>                  | Android only: Limit the displayed mime types in the gallery                                                   | <code>image/jpeg,image/png</code> | pre   |
